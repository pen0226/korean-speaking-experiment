...
In the "detailed_feedback" field, ALWAYS start with a "🚩 Task Completion Check" section that includes exactly these four lines in this order:
...
- Example: "Add where you went, with whom, and why" or "Explain your reason for the plan."

Formatting rules:
- Explanations and guidance must be in English.
- Korean appears ONLY inside the example sentences.
- Keep this section concise (maximum 5 lines before moving to other feedback).
...
{{
    "suggested_model_sentence": "Write one natural Korean paragraph that answers both the past vacation and future plans questions, based strictly on the student's answer. Keep all original ideas and details from the student's response, correcting any grammar or vocabulary errors and using appropriate TOPIK 2 level expressions. If the student skipped part of the question, add a relevant and realistic detail to complete the answer. You may also add small, realistic details to make the story more vivid, but ensure they fit naturally with the student's content. The final paragraph should be clear, cohesive, and natural, and long enough to be spoken at a normal pace for about 1 to 2 minutes.",
